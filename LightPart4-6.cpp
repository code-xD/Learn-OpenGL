...
int main()
{
    ...
    // Creating a light/lamp object. Adding a new VAO because we don't want same shaders.
    ...
    Shader lightingShader("Shaders/objectshader3.vs", "Shaders/objectshader3.fs");

    lightingShader.use();
    // Set the location of sampler Texture for diffusion.
    lightingShader.setInt("material.diffuse", 0);
    // Set the location of sampler Texture for specular reflection.
    lightingShader.setInt("material.specular", 1);
    // setting the shinniness.
    lightingShader.setFloat("material.shininess", 64.0f);
    
    // Loading the Texture
    unsigned int diffuseMap = LoadTexture("Textures/container2.png", "png");
    unsigned int specularMap = LoadTexture("Textures/container2_specular.png", "png");
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // spotLight at camera location
        lightingShader.setVec3("spotLight.position", cameraPos.x, cameraPos.y, cameraPos.z);
        lightingShader.setVec3("spotLight.direction", cameraFront.x, cameraFront.y, cameraFront.z);
...
void LinkVertexToShaderProgram() {
    ...
    //Loading the normal coordinates
