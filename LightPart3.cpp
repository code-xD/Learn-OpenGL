...
int main()
{
    ...
    Shader lightingShader("Shaders/objectshader2.vs", "Shaders/objectshader2.fs");

    lightingShader.use();

    lightingShader.setVec3("objectColor", 1.0f, 0.5f, 0.31f);
    
    // Colour which object emits under ambient lighting.
    lightingShader.setVec3("material.ambient", 1.0f, 0.5f, 0.31f);
    // Colour which object emits under diffused reflection.
    lightingShader.setVec3("material.diffuse", 1.0f, 0.5f, 0.31f);
    // Colour which object emits under specular reflection.
    lightingShader.setVec3("material.specular", 0.5f, 0.5f, 0.5f);
    // setting the shinniness.
    lightingShader.setFloat("material.shininess", 32.0f);

    // Do the same for lamp light
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightPos.x = 0.5f + sin(glfwGetTime()) * 2.0f;
        lightPos.z = 0.5f + cos(glfwGetTime()) * 2.0f;
